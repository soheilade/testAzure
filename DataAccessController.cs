...
namespace CoursesWebApp.Models
{
    public class DataAccessController
    {
        ...
        private string connectionString = "Server=tcp:uniserver1364.database.windows.net,1433;Initial Catalog=unidb;Persist Security Info=False;User ID=azuresql;Password=Welcome3!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
